	...
	public ResponseModel callBckOfficeAPI(long applicationId) {
	    ...
	    try {
	       ...
	       RequestBody body = RequestBody.create(mediaType, xmlContent);
	        ...
	        commonMethods.sendErrorMail("An error occurred while processing your request. In backOfficeApiService callBckOfficeAPI for the Error: " + e.getMessage(), "ERR-002");
	    }
